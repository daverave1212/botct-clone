...
const availableEmojis = randomizeArray(
    [
        ...EmojiDatabase.emojis['People & Body']['person-fantasy'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-amphibian'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-bird'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-bug'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-mammal'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-marine'],
        ...EmojiDatabase.emojis['Animals & Nature']['animal-reptile'],
        ...EmojiDatabase.emojis['Animals & Nature']['plant-flower'],
        ...EmojiDatabase.emojis['Food & Drink']['food-fruit'],
        ...EmojiDatabase.emojis['Food & Drink']['food-vegetable'],
        ...EmojiDatabase.emojis['Food & Drink']['food-sweet']
    ].map(obj => obj.emoji)
).slice(0, 30)
