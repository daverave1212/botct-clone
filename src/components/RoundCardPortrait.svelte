...
<script>
    ...
    import { EVIL_COLOR, MORNING_COLOR, NIGHTLY, NIGHTLY_COLOR, OTHER_CATEGORY, PINK_COLOR, REGULAR, SETUP, SETUP_COLOR, SPECIAL_COLOR, SPECIAL_NIGHTLY, SPECIAL_SETUP } from "$lib/shared-lib/SharedDatabase";
    ...
    $: _name = name ?? role.name
    $: _src = src ?? role.src
    $: _isBig = isBig ?? role.isBig
