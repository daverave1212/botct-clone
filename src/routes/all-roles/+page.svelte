...
<script>
    ...
    import { ADVANCED, TROUBLE_BREWING, BAD_MOON_RISING, difficultyDescriptions, difficultyNames, getAllRoleDifficulties, getDifficultyByFirstLetter, getFirstLetterOfDifficulty, getNormalRolePriority, getRoles, getRolesByDifficulty, getRolesForDifficulty, getSortRolesWithPriorityFunction, MORNING_COLOR, NIGHTLY_COLOR } from "$lib/shared-lib/SharedDatabase";
